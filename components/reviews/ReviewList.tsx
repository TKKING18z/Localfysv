...
interface ReviewListProps {
  ...
  sortBy: ReviewSortMethod; // Use the more specific type
  onSortChange: (sort: ReviewSortMethod) => void; // Use the more specific type
  // Add this prop to control the rendering mode
